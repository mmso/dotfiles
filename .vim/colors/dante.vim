...
" General colors
hi Normal	ctermfg=gray guifg=grey guibg=black
...
hi Folded	term=standout ctermfg=blue ctermbg=darkgray guifg=royalblue1 guibg=white
...
" syntax hi colors
hi Comment	term=bold ctermfg=darkgray guifg=cyan4
hi PreProc	term=underline ctermfg=brown guifg=dodgerblue4
hi Constant	term=underline ctermfg=green guifg=firebrick3
hi Type		term=underline ctermfg=darkblue gui=none guifg=chartreuse3
hi Statement	term=bold ctermfg=brown  gui=none guifg=gold3
hi Identifier	term=underline ctermfg=darkmagenta guifg=darkolivegreen4
...
hi Number	term=underline ctermfg=gray guifg=red2
" syntax hi links
